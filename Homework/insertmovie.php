...
<body>
    ...
    <form class="container" id="form1" name="form1" method="post" action="insertmoviesucess.php">
        ...
        <p>
            <label for="movie_time">แนว</label>
            <input type="text" name="movie_time" id="movie_time">
        </p>

        <p>
            <label for="movie_category">เวลา</label>
            <input type="text" name="movie_category" id="movie_category">
        </p>

        <p>
            <label for="movie_detail">รายระเอียด</label>
            <input  type="message" name="movie_detail" id="movie_detail">
        </p>
        <input type="submit" class="btn btn-success" value="บันทึก">
        <a class="btn btn-success" href='Movie.php'>ยกเลิก</a>
    </form>
</body>
