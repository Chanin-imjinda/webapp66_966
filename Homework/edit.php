...
<body>
    ...
    <form class="container" id="form1" name="form1" method="post" action="editsucess.php">
        ...
        <p>
            ...
            <input type="text" name="m_email" id="m_email" value="<?=$row['m_email'];?>" />
        </p>

        <p>
            <label for="m_telephone">เบอร์โทร</label>
            <input type="text" name="m_telephone" id="m_telephone" value="<?=$row['m_telephone'];?>" />
        </p>
        <input type="submit" class="btn btn-success" value="บันทึก">
        <a class="btn btn-success" href='main.php'>ยกเลิก</a>
    </form>
</body>
