                ...
                <?php
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            echo "<tr><td>".$row["movie_id"]."</td>"."<td>".$row["movie_name"]."</td>"."<td>".$row["movie_category"]."</td>"."<td>".$row["movie_time"]."</td>"."<td>".$row["movie_detail"]."</td>"
                            ."<td>"."<a class='btn btn-warning' href='editmovie.php?movie_id=".$row["movie_id"]."'>Edit</a>"."</td>"
                            ."<td>"."<a class='btn btn-danger' href='deletemovie.php?movie_id=".$row["movie_id"]."'>Delete</a>"."</td>";
                            echo "</tr>";    
                        }
                    }else {
                        echo "0 results";
